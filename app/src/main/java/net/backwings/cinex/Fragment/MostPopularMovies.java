...
public class MostPopularMovies extends Fragment implements LoaderManager.LoaderCallbacks<ArrayList<MovieModel>> {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        getLoaderManager().initLoader(100,null,this).startLoading();
    ...
    public Loader<ArrayList<MovieModel>> onCreateLoader(int id, Bundle args) {
        return new MovieDataLoader(getContext(), NetworkUtils.POPULAR_MOVIE_URL);
    }
